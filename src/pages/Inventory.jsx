...
export function Inventory() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
      ...
      {/* Header mirip Point of Sales */}
      <h2 className="col-span-full text-center font-extrabold text-2xl text-gray-800 uppercase bg-gradient-to-r from-green-100 via-white to-green-100 rounded-full py-3 shadow-md">
        STOCK MANAJEMEN
      </h2>
